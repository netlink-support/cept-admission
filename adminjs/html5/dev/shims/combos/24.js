...
jQuery.webshims.register(
    'dom-extend', function ($, webshims, window, document, undefined) {
        "use strict";
        //shortcus
        ...
        [{name: 'getNativeElement', prop: 'nativeElement'}, {name: 'getShadowElement', prop: 'shadowElement'}, {name: 'getShadowFocusElement', prop: 'shadowFocusElement'}].forEach(
            function (data) {
            ...
            function (type) {
                ...
                $[type] = function (elem, name, value, pass, _argless) {
                    ...
                    if((value !== undefined || curType === 'removeAttr') && modifyProps[nodeName] && modifyProps[nodeName][name]) {
                        ...
                        modifyProps[nodeName][name].forEach(
                            function (fn) {
            ...
            extendUNDEFProp: function (obj, props) {
                ...
                addShadowDom: (function () {
                    ...
                    var docObserve = {
                        ...
                        _create: function () {
                            $.each(
                                { Height: "getHeight", Width: "getWidth" }, function (name, type) {
                ...
                activeLang: (function () {
                    ...
                    var callRegister = function (module) {
                        if(registeredCallbacks[module]) {
                            registeredCallbacks[module].forEach(
                                function (data) {
                                    data.callback();
                                }
                            );
...
(function ($, document) {
    ...
    if (!$.browser.msie || (browserVersion < 12 && browserVersion > 7)) {
        ...
        $.webshims.addReady(
            function (context, contextElem) {
                $.each(
                    elemMappings, function (name, role) {
...
jQuery.webshims.register(
    'form-datalist', function ($, webshims, window, document, undefined) {
        "use strict";
        var doc = document;    
            ...
            */
            ...
            var shadowListProto = {
                _create: function (opts) {
                    ...
                    this.shadowList
                    .delegate(
                        'li', 'mouseenter.datalistWidget mousedown.datalistWidget click.datalistWidget', function (e) {
                    ...
                    if(opts.input.form && (opts.input.name || opts.input.id)) {
                        $(opts.input.form).on(
                            'submit.datalistWidget'+opts.input.id, function () {
                    ...
                    $(window).on(
                        'unload.datalist'+this.id+' beforeunload.datalist'+this.id, function () {
                            that.destroy();
                        }
                    );
                },
                ...
                showList: function () {
                    ...
                    .on(
                        'mousedown.datalist'+that.id +' focusin.datalist'+that.id, function (e) {
                    ...
                    .on(
                        'updateshadowdom.datalist'+that.id, function () {
                            that.setPos();
                        }
                    );
                    return true;
                ...
                hideList: function () {
                    ...
                    .off('.datalist'+that.id)
                    .one(
                        'resize.datalist'+that.id, function () {
