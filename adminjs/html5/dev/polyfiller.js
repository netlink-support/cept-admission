(function (factory) {
    ...
    var webshims = {
        ...
        */
        ...
        addPolyfill: function (name, cfg) {
            ...
            if (cfg.methodNames) {
                $.each(
                    cfg.methodNames, function (i, methodName) {
                ...
                $.each(
                    features, function (i, feature) {
                        ...
                        if (feature !== webshimsFeatures[feature][0]) {
                            onReady(
                                webshimsFeatures[feature], function () {
                                    isReady(feature, true);
                                }
                            );
                        }
            ...
            loadList: (function () {
                ...
                var setDependencies = function (module, list) {
                    if (module.d && module.d.length) {
                        ...
                        $.each(
                            module.d, function (i, dependency) {
                                ...
                                if (webshimsFeatures[dependency]) {
                                    ...
                                    onReady(
                                        webshimsFeatures[dependency], function () {
                ...
                return function (list, combo) {
                    ...
                    var loadCombo = function (j, combo) {
                        foundCombo = combo;
                        $.each(
                            webshims.c[combo], function (i, moduleName) {
    ...
    */
    ...
    $.each(
        ['log', 'error', 'warn', 'info'], function (i, fn) {
    ...
    */
    ...
    (function () {
        ...
        $.each(
            ['after', 'before', 'append', 'prepend', 'replaceWith'], function (i, name) {
        ...
        $.each(
            ['insertAfter', 'insertBefore', 'appendTo', 'prependTo', 'replaceAll'], function (i, name) {
                $.fn[name.replace(
                    /[A-Z]/, function (c) {
                        return "Polyfill"+c;}
                )] = function () {
        ...
        $.each(
            ['getNativeElement', 'getShadowElement', 'getShadowFocusElement'], function (i, name) {
                $.fn[name] = function () {
                    return this;
                };
            }
    ...
    */
                    ...
                    afterLoad: function () {
                        webshims.addReady(
                            function (context, elem) {
                                ...
                                $('canvas', context).add(elem.filter('canvas')).each(
                                    function () {
    ...
    //<mediaelement
    needModernizr(
        'audio video texttrackapi', function () {
