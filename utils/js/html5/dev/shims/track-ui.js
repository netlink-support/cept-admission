jQuery.webshims.register(
    'track-ui', function ($, webshims, window, document, undefined) {
        "use strict";
        ...
        var trackDisplay = {
            ...
            showCues: function (baseData) {
                ...
                $.each(
                    baseData.displayedActiveCues, function (i, cue) {
                ...
                .each(
                    function () {
                        ...
                        if(!usesNativeTrack()) {
                            ...
                            elem.on(
                                'mediaelementapichange trackapichange', function () {
