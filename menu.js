...
jQuery(function () {
    ...
    $('#menu #menu1').addClass('js-active');
    $('ul div', '#menu').css('visibility', 'hidden');
	 $('ul div', '#menu1').css('visibility', 'hidden');
	...
	var links = $('.menu>li>a, .menu>li>a span', '#menu1').css({
        background: 'none'
    });
    $('#menu1 ul.menu').lavaLamp({
        speed: 600
    });
