    ...
    a.flexslider = function (c, b) {
        ...
        d.init = function () {
            ...
            if (d.vars.animation.toLowerCase() == "slide") {
                ...
                d.css({overflow:"hidden"/*, border:"1px solid #FFF", outline:"1px solid #BBB"*/});
            ...
            if (!d.animating) {
                ...
                if (d.vars.animation.toLowerCase() == "slide") {
                    ...
                    if (d.transitions) {
                        ...
                        d.container.animate(
                            d.args, d.vars.animationDuration, function () {
                                d.wrapup(e)
                            }
                        )
                    }
        ...
        d.getTargetSlidenumber=function (e) {
            if (d.direction == "next") {
                return d.getTarget("next");
            }
            else
            {
                return d.getTarget("prev");
            }
        }
